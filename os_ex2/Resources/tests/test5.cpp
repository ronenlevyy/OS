...
int main() {
    std::string cd = "cd /cs/usr/ruppin/CLionProjects/os-ex-2/";
    system(cd.c_str());
    std::string command = "g++ -std=c++11 -fsanitize=address -fno-omit-frame-pointer -g uthreads.cpp ./tests/DoNotRunThis.cpp -o test_asan";
